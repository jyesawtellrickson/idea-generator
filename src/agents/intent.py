...
def gen_idea_generator_agent(args, tools):
    ...
    def make_system_prompt():
        return (
            "You are part of a system of agents that act as a research idea"
            " generator. Your job is to work out the intent from a user message"
            " You should respond with one of: 'generation', 'feedback',"
            " 'reserch', 'chat', 'other'."
        )
